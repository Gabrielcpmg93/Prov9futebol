...
const QuickActionCard: React.FC<QuickActionCardData> = ({ icon, bgColor, iconColor, title, onClick }) => {
  return (
    <button onClick={onClick} className="w-full bg-white rounded-2xl p-4 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow cursor-pointer aspect-square">
