...
export const SirenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0M3.124 11.168a23.848 23.848 0 012.312-6.022 8.967 8.967 0 016.022-2.312c1.733-.64 3.56-1.085 5.455-1.31a8.967 8.967 0 016.022 2.312 23.848 23.848 0 012.312 6.022M3.124 11.168c-.64 1.733-1.085 3.56-1.31 5.455a8.967 8.967 0 012.312 6.022m17.502 0a8.967 8.967 0 01-6.022 2.312c-1.733.64-3.56 1.085-5.455 1.31a8.967 8.967 0 01-6.022-2.312m17.502 0a23.848 23.848 0 00-2.312-6.022"/>
  </svg>
);

export const SproutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.624l-.219.669-.219-.669a2.25 2.25 0 00-1.378-1.378l-.67-.219.67-.219a2.25 2.25 0 001.378-1.378l.219-.67.219.67a2.25 2.25 0 001.378 1.378l.669.219-.669.219a2.25 2.25 0 00-1.378 1.378z" />
  </svg>
);
...
export const GraduationCapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 14v6m-6-3.837V11.25A11.952 11.952 0 0112 8.055a11.952 11.952 0 016 3.195V16.163" />
  </svg>
);
...
export const HomeIcon: React.FC<{filled?: boolean} & React.SVGProps<SVGSVGElement>> = ({ filled, ...props }) => (
...
export const GlobeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.53v16.94M3.53 12h16.94" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 8.75c1.714 2.5 4.857 4.5 8 4.5s6.286-2 8-4.5M4 15.25c1.714-2.5 4.857-4.5 8-4.5s6.286 2 8 4.5" />
    </svg>
);
